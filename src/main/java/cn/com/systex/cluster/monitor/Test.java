...
public class Test {
	public static void main(String[] args) throws IOException {
		...
		// DFSFileUtil.init("/var/lib/hadoop-hdfs/gelicollect/conf/hadoop.properties");
...
//		System.out.println(used);
		...
		// System.out.println("Configured Capacity     （单位字节）:"
		// + hdfs.getRawCapacity());
		// System.out.println("DFS Used     （单位字节）:" + hdfs.getRawUsed());
		// System.out.println("DFS Remaining    （单位字节） :"
		// + hdfs.getDiskStatus().getRemaining());
		...
		// System.out.println("Number of Under-Replicated Blocks     :"
